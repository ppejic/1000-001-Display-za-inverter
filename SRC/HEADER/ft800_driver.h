#ifndef __FT800_DRIVER_H
#define __FT800_DRIVER_H
...
#define DL_CLEAR_TAG        	0x06000000UL // requires OR'd arguments
...
#define LCD_HCYCLE			548UL
#define LCD_HOFFSET			43UL
#define LCD_HSYNC0			0
#define LCD_HSYNC1			41
#define LCD_VCYCLE			292
#define LCD_VOFFSET			12
#define LCD_VSYNC0			0
#define LCD_VSYNC1			10
#define LCD_PCLK				5
#define LCD_SWIZZLE			0
#define LCD_PCLKPOL			1

// REG_TOUCH_MODE options
...
// RZTHRESH options
#define RZTHRESH_DEFAULT				1200

#define ENTER_SCREEN_ID									0
#define MAIN_SCREEN_ID									1
#define VEHICELSTATUS_SCREEN_ID					2
#define FAULTLOG_SCREEN_ID							3
#define ADMINMENU_SCREEN_ID							4
#define ADMINMAIN_SCREEN_ID							5
#define ADMINVEHICLESTATUS_SCREEN_ID		6
#define ADMINFAULTLOG_SCREEN_ID					7
#define ADMINTEST_SCREEN_ID							8
#define ADMINSETTIME_SCREEN_ID					9
#define ENTERSCREEN_ID									10

#define CONVERTCOORDINATES_X(x) (uint16_t)(((float)(x)/480)*1024)
#define CONVERTCOORDINATES_Y(y) (uint16_t)(((float)(y)/270)*1024)
/*********************************STRUCTURES****************************************/
struct lcd_state_header;
typedef struct lcd_state_header* lcd_state_header_ptr;
...
#define DEFINE_LCD_STATE(NAME)																									\
	lcd_state_header_ptr NAME##_state() {																						\
		static lcd_state_header_t state;																						\
																																								\
		state.process_input = NAME##_process_input;																		\
		state.update_frame  = NAME##_update_frame;																		\
																																								\
		return &state;																															\
	}

DECLARE_LCD_STATE(admin_fault_details)
DECLARE_LCD_STATE(admin_fault_log);
DECLARE_LCD_STATE(admin_menu);
DECLARE_LCD_STATE(admin_main);
DECLARE_LCD_STATE(admin_vehicle_status);
DECLARE_LCD_STATE(login);
DECLARE_LCD_STATE(main);
...
void FT800_FaultLogScreen(void);
void FT800_AdminMenuScreen(void);
void FT800_AdminMainScreen(void);
void FT800_AdminVehicleStatusScreen(void);
...
extern uint32_t ramCommandBuffer;
